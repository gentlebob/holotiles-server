...
def is_ended(r: redis.Redis, video_id: str) -> bool:
    return bool(r.sismember(_ended_key(), video_id))


def add_ended(r: redis.Redis, video_ids: list[str]) -> None:
    if video_ids:
        r.sadd(_ended_key(), *video_ids)
